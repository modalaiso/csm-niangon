...
export function AnnouncementPopup(props: Readonly<AnnouncementPopupProps>) {
  ...
  return (
    <button
      ...
      className="fixed inset-0 z-[100] flex items-center justify-center bg-black/50 p-4 border-0 w-full cursor-default"
    ...
    >
      ...
      >
        <div 
          ...
          aria-modal="true"
          aria-label={current.title} 
          className="relative flex h-full max-h-96 w-full max-w-2xl flex-col overflow-hidden rounded-3xl bg-white shadow-2xl text-left cursor-auto" 
