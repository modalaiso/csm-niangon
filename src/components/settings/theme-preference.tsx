      ...
      {options.map((option) => {
        ...
        return (
          <label
            key={option.value}
            className={cn(
              "relative flex min-h-32 flex-col items-start rounded-2xl border p-4 text-left transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 cursor-pointer",
              isSelected
