...
export default async function AdminSchedulesPage() {
  ...
  const [classes, subjects] = await Promise.all([getSchoolClasses(), listSubjects()]);
    ...
    <div>
      <div className="mb-6">
        ...
        <p className="mt-1 text-sm text-muted-foreground">
          Gérez les classes, les matières, et l&apos;emploi du temps de chaque classe.
        </p>
      </div>
      <ClassSubjectManager initialClasses={classes} initialSubjects={subjects} />
    </div>
  );
}